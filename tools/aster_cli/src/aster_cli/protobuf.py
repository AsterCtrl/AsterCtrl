...
def _support_header(schema_hash: str, *, has_services: bool) -> str:
    ...
    rpc_header = '#include "aster_module_cpp_interface/rpc.hpp"\n' if has_services else ""
...
{rpc_header}#include "aster_module_cpp_interface/type_support.hpp"

#ifndef ASTER_PROTO_BOUNDED_COMMON
#define ASTER_PROTO_BOUNDED_COMMON
