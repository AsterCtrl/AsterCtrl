...
#include "aster_runtime/static_hardware.hpp"
...
class StaticNodeRuntime final {
 public:
  ...
  Status AddInfrastructureModule(ModuleBase& module, std::string_view instance_name) noexcept {
