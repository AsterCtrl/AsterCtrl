...
For Zephyr, keep the last known-good firmware and matching
`deployment.lock.yaml`, and verify both against the published checksums. Flash
them together through the board's configured runner; do not mix firmware and
locks from different releases.
